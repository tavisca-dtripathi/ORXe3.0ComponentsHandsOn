...
(function (LitHtmlDiagnosticKind) {
    ...
    LitHtmlDiagnosticKind["LEGACY_SYNTAX"] = "LEGACY_SYNTAX";
...
var rule$f = {
    ...
    visitHtmlAttribute: function (htmlAttr, _a) {
        ...
        if (suggestedName !== htmlAttr.name) {
            return [
                {
                    kind: exports.LitHtmlDiagnosticKind.LEGACY_SYNTAX,
    ...
    visitHtmlAssignment: function (assignment, _a) {
        var htmlStore = _a.htmlStore, config = _a.config, definitionStore = _a.definitionStore, document = _a.document;
        if (assignment.kind !== HtmlNodeAttrAssignmentKind.STRING) {
            return;
        }
...
function visitDependencies(node, context) {
    ...
    if (context.ts.isSourceFile(node)) {
        ...
        if (node.moduleSpecifier != null && context.ts.isStringLiteral(node.moduleSpecifier) &&
            ...
            ((_a = context.depth, (_a !== null && _a !== void 0 ? _a : 0)) < MAX_DEPTH || !context.program.isSourceFileFromExternalLibrary(node.parent))) {
    ...
    if (mod != null) {
        ...
        if (!isCircularImport) {
            if (sourceFile != null) {
                ...
                visitDependencies(sourceFile, __assign(__assign({}, context), { depth: (_a = context.depth, (_a !== null && _a !== void 0 ? _a : 0)) + 1 }));
            }
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, isSuccessful(stats, config)];
            }
        });
    });
}
