...
var transformAnalyzerResult = require('./chunk-96aed7e6.js');
        ...
        return transformAnalyzerResult.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (config.debug) {
                        console.dir(transformAnalyzerResult.stripTypescriptValues(result, program.getTypeChecker()), { depth: 10 });
                    }
...
function analyzeComponentsInFile(file, program, config) {
    ...
    return transformAnalyzerResult.analyzeSourceFile(file, options);
}
/**
 * Expands the globs.
 * @param globs
                ...
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(globs.map(function (g) {
                            try {
                                ...
                                if (dirExists) {
                                    return fastGlob(transformAnalyzerResult.__spread((config.discoverLibraryFiles || g.includes("node_modules") ? [] : IGNORE_GLOBS), [path.join(g, DEFAULT_DIR_GLOB)]), {
                                        absolute: true,
                            ...
                            return fastGlob(transformAnalyzerResult.__spread((config.discoverLibraryFiles || g.includes("node_modules") ? [] : IGNORE_GLOBS), [g]), {
                                absolute: true,
                                followSymbolicLinks: false
                            });
                        }))];
...
var CommandError = /** @class */ (function (_super) {
    transformAnalyzerResult.__extends(CommandError, _super);
            ...
            return transformAnalyzerResult.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        // Analyze all globs
                        return [4 /*yield*/, analyzeGlobs(inputGlobs, config, transformAnalyzerResult.__assign(transformAnalyzerResult.__assign({}, context), { emitAnalyzedFile: function (file, result, _a) {
                    ...
                    case 3:
                        ...
                        fs.writeFileSync(path$1, transformed);
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, analyzeGlobs(inputGlobs, config, transformAnalyzerResult.__assign(transformAnalyzerResult.__assign({}, context), { emitAnalyzedFile: function (file, result, _a) {
                                var program = _a.program;
...
function parseCliArguments(args) {
    ...
    for (var i = 0; i < args.length; i++) {
        ...
        if (arg.startsWith("-")) {
            // Parses: "--key=value"
            if (arg.includes("=")) {
                var _a = transformAnalyzerResult.__read(arg.split("="), 2), key = _a[0], value = _a[1];
        ...
        return transformAnalyzerResult.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Print "version"
                    if ("version" in args) {
                        console.log(transformAnalyzerResult.VERSION);
                        process.exit();
                    }
                ...
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, command.run.apply(command, transformAnalyzerResult.__spread([args], args._.slice(1)))];
                case 5:
                    exitCode = _a.sent();
